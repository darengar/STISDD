...
namespace EMR.Areas.Department.Controllers
{
    public class ChiefComplaintController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "ChiefComplaintId,HospitalizationId,LeadTime,ChestPain,Dyspnea,Syncope,Palpitation,Edema,ETC")] ChiefComplaint chiefcomplaint)
        {
